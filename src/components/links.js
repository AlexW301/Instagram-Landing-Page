...
function Links() {
    return (
        <Container>
            <Button text="Get Pre Approved Now!" image="https://www.freeiconspng.com/uploads/mouse-cursor-click-png-12.png" className='applyIcon' link='https://michaelcomerford.floify.com/apply-now'/>
